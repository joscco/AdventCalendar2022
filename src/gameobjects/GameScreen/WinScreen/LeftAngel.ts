...
export class LeftAngel extends Container {
    ...
    constructor() {
        ...
        this.body = new Sprite(ASSET_STORE.getTextureAsset("angel1Body"))
        this.body.anchor.set(0.5)

        this.frontWing = new Sprite(ASSET_STORE.getTextureAsset("angel1RightWing"))
        this.frontWing.anchor.set(0.97, 0.8)
        this.frontWing.position.set(-90, -20)

        this.backWing = new Sprite(ASSET_STORE.getTextureAsset("angel1LeftWing"))
        this.backWing.anchor.set(0.91, 0.85)
        this.backWing.position.set(-40, -40)

        this.legs = new Sprite(ASSET_STORE.getTextureAsset("angel1Legs"))
