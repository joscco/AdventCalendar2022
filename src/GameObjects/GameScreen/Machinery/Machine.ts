...
export class Block extends Sprite {
    ...
    updateAppearance() {
        this.texture = ASSET_MANAGER.getTextureAsset(("block_" + this.machineShape))
    }
}
...
export class Machine extends Block {
    ...
    public updateAppearance() {
        if (this.type) {
            ...
            this.texture = ASSET_MANAGER.getTextureAsset(("machine_" + this.machineShape))
        }

        if (this.positionLocked) {
            this.chainOverlay.texture = ASSET_MANAGER.getTextureAsset("chain_" + this.machineShape)
        } else {
...
export class Cage extends Block {
    ...
    public updateAppearance() {
        this.texture = ASSET_MANAGER.getTextureAsset("cage")
    }
}
